...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-orange-500 text-slate-50 shadow hover:bg-orange-600 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-orange-50/90",
        destructive:
        ...
        secondary:
          "bg-orange-100 text-orange-500 shadow-sm hover:bg-orange-200/70 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80",
        ghost:
