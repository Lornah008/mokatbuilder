        ...
        <section>
            ...
            <div className="max-w-7xl relative mx-auto">
                ...
                <div className="absolute max-w-xl lg:max-w-2xl inset-x-4 sm:left-8 top-20 md:top-10 lg:top-20">
                    ...
                    <h1 className='sm:mt-4 text-xl lg:text-3xl text-gray-800 font-semibold'>About Us</h1>
            ...
            <img className="w-full max-h-[560px] object-cover object-center hidden sm:block" src="/assets/hero-about-us-image.png" alt="Hero Image" />
            <img className="aspect-square object-cover object-left sm:hidden" src="/assets/hero-about-us-image.png" alt="Hero Image" />
